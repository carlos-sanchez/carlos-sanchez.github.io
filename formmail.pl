...
#$mailprog = '/var/qmail/bin/sendmail -i -t';
...
@referers = ('carloscv.com','www.carloscv.com');

# @recipients defines the e-mail addresses or domain names that e-mail can   #
# be sent to.  This must be filled in correctly to prevent SPAM and allow    #
# valid addresses to receive e-mail.  Read the documentation to find out how #
# this variable works!!!  It is EXTREMELY IMPORTANT.                         #
@recipients = &fill_recipients('carloscv.com','contact@carloscv.com');
...
sub return_html {
    ...
    # Otherwise, begin printing the response page.                           #
        ...
        else { print "<h1>Gracias por enviar su informacion</h1>\n" }
...
sub send_mail {
    ...
    else                    { print MAIL "Subject: envio de formulario\n\n" }

    print MAIL "Este es el resultado del formulario.\n";
