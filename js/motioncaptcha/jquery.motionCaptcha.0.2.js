...
jQuery.fn.motionCaptcha || (function($) {
	...
	$.fn.motionCaptcha.defaults = {
		...
		// Canvas vars:
		canvasFont: '15px "Arial"',
		canvasTextColor: '#56C956',
		...
		noCanvasMsg: "Your browser is too old! Try Chrome or send me an e-mail to contact@carloscv.com",
		
		// This could be any HTML string (eg. '<label>Draw this shit yo:</label>'):
		label: '<p>Use your mouse to draw the shape below:</p>',
